...
--
-- Host: 172.19.67.42    Database: market_db
-- ------------------------------------------------------
...
CREATE TABLE `product_tag` (
  ...
  KEY `fk_producttag_tag` (`tag_id`),
  CONSTRAINT `fk_producttag_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  CONSTRAINT `fk_producttag_tag` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-02 19:34:38
